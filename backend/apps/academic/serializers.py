...
class SubjectSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Subject
        fields = ['id', 'name', 'code', 'description', 'class_name', 'teacher',
                 'class_name_id', 'teacher_id', 'created_at']
        read_only_fields = ['created_at']
...
class AttendanceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Attendance
        fields = ['id', 'student', 'section', 'date', 'is_present', 'remarks',
                 'student_id', 'section_id', 'created_at']
        read_only_fields = ['created_at']
...
class AssessmentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Assessment
        fields = ['id', 'name', 'subject', 'section', 'date', 'total_marks',
                 'subject_id', 'section_id', 'created_at']
        read_only_fields = ['created_at']
...
class AssessmentResultSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'assessment', 'student', 'marks_obtained', 'remarks',
                 'assessment_id', 'student_id', 'created_at']
        read_only_fields = ['created_at']
...
class AssignmentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Assignment
        fields = ['id', 'title', 'description', 'subject', 'section',
                 'due_date', 'file', 'subject_id', 'section_id',
...
class AssignmentSubmissionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'assignment', 'student', 'file', 'submitted_at',
                 'remarks', 'score', 'assignment_id', 'student_id']
...
class TimetableSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Timetable
        fields = ['id', 'section', 'subject', 'weekday', 'start_time',
                 'end_time', 'section_id', 'subject_id', 'created_at']
        read_only_fields = ['created_at']
    ...
    def validate(self, data):
        ...
        for entry in conflicts:
            if (
                (data['start_time'] >= entry.start_time and
                 data['start_time'] < entry.end_time) or
                (data['end_time'] > entry.start_time and
                 data['end_time'] <= entry.end_time) or
                (data['start_time'] <= entry.start_time and
