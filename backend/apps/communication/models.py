...
class Announcement(models.Model):
    ...
    target_roles = models.JSONField(help_text='List of user roles who can see this announcement')
    target_classes = models.ManyToManyField(Class, blank=True, related_name='announcements')
    target_sections = models.ManyToManyField(Section, blank=True, related_name='announcements')
