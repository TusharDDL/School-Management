...
class StudentFee(models.Model):
    ...
    discount = models.ForeignKey(Discount, on_delete=models.SET_NULL, null=True, blank=True, related_name='student_fees')
...
class Payment(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        total_paid = student_fee.payments.aggregate(models.Sum('amount'))['amount__sum'] or 0
