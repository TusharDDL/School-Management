...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('AVAILABLE', 'ISSUED', 'LOST', 'DAMAGED', 'UNDER_REPAIR', name='bookstatus'), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.PrimaryKeyConstraint('id')
    ...
    sa.Column('role', sa.Enum('ADMIN', 'TEACHER', 'STUDENT', 'PARENT', 'LIBRARIAN', 'ACCOUNTANT', name='userrole'), nullable=True),
    ...
    op.create_index(op.f('ix_library_members_card_number'), 'library_members', ['card_number'], unique=True)
    op.create_index(op.f('ix_library_members_id'), 'library_members', ['id'], unique=False)
    ...
    op.create_table('book_circulations',
    ...
    sa.Column('status', sa.Enum('ISSUED', 'RETURNED', 'OVERDUE', 'LOST', name='circulationstatus'), nullable=True),
    ...
    op.create_index(op.f('ix_book_circulations_id'), 'book_circulations', ['id'], unique=False)
